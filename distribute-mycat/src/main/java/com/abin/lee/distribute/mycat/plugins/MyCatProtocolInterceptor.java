package com.abin.lee.distribute.mycat.plugins;

import com.abin.lee.distribute.mycat.common.MyCatContextHolder;
import com.abin.lee.distribute.mycat.common.ReflectHelper;
...
public class MyCatProtocolInterceptor implements Interceptor {

	@Override
	public Object intercept(Invocation invocation) throws Throwable {
		
		String tenant = MyCatContextHolder.getTenant();
